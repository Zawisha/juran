...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'image' => [
            'mimes' =>'Файл должен иметь расширение jpeg,jpg,png',
            'max' =>'Файл не должен превышать 8мб',
        ],
        'new_pass' => [
            'min' =>'Пароль должен быть не менее 6 символов',
            'max' =>'Поле Пароль не может быть больше 30 символов',
        ...
        'user_name' => [
            'min' =>'Имя должно быть не менее 2 символов',
            'max' =>'Поле Имя не может быть больше 30 символов',
            'required' =>'Поле Имя обязательно для заполнения',
        ],
        'user_surname' => [
        ...
        'user_telefon_number' => [
            'min' =>'Поле телефон должно быть не менее 5 символов',
            'max' =>'Поле телефон не может быть больше 30 символов',
            'required' =>'Поле телефон обязательно для заполнения',
        ],
    ],
