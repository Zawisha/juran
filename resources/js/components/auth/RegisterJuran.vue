                        ...
                        <div class="div-block-registr">
                            <div class="div-block-19">
                                <div>
                                    ...
                                    <div class="w-form">
                                    <form @submit.prevent="reg_log"  id="wf-form-Enter-login" name="wf-form-Enter-login" data-name="" class="form">
                                        ...
                                        <div class="div-block-25">
                                            ...
                                            <router-link  :to="{ name:'login_juran'}"><a href="" class="link-4">Войти</a></router-link>
                                        </div>
                                    </form>
                ...
                this.$auth.login({
                   ...
                   fetchUser: true,
                    ...
                    .then(response => {
                        ...
                        {
                            this.error = true;
                            this.error_arr_new = Object.entries(response.data);
