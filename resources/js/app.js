...
Vue.component('tooltip_modal', require('./components/medical/TooltipModal').default);
Vue.component('modal_error', require('./components/profile/ModalError').default);
...
import PostsListJuran from "./components/medical/PostsListJuran";
...
import ProfileJuran from "./components/profile/ProfileJuran";
import ExpertiseJuran from "./components/profile/ExpertiseJuran";
import SubjectsList from "./components/profile/SubjectsList";
import EditSubject from "./components/document/EditSubject";
import Settings from "./components/profile/Settings";
import PageNotFound from "./components/PageNotFound";
import TooltipContent from "./components/medical/TooltipContent";
import AdminJuran from "./components/medical/AdminJuran";
import SubjectsListJuran from "./components/profile/SubjectsListJuran";
...
const router = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            path: '/',
            name: 'profile_juran',
            component: ProfileJuran,
            beforeEnter: (to, from, next) => {

                    axios.post('/is_log').then(response => {
                        if(response.data =='1')
                        {
                            next({ })
            ...
            children: [
                ...
                {
                    path: '',
                    name: 'expertise_juran',
                    component: ExpertiseJuran,
                    props: true,
                },
                {
                    path: '/expertise_test',
